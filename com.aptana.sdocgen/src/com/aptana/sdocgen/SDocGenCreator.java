...
import com.aptana.sdocgen.reflection.TypeManager;
import com.aptana.sdocgen.utils.FileUtils;

/**
 * @author Kevin Lindsey
 */
public class SDocGenCreator
{
	...
	private static final String SDOCGEN_LXR_RESOURCE = "/com/aptana/sdocgen/resources/sdocgen.lxr";
	private static final String SDOCGEN_BNF_RESOURCE = "/com/aptana/sdocgen/resources/sdocgen.bnf";
	private static final String USAGE_TEXT_RESOURCE = "/com/aptana/sdocgen/resources/usage.txt";
	...
	private SDocGenHandler _handler;
	...
	public static void main(String[] args)
	{
		...
		if (args.length > 0)
		{
			SDocGenCreator creator = new SDocGenCreator();
...
//					}
	...
	{
		InputStream is = SDocGenCreator.class.getResourceAsStream(USAGE_TEXT_RESOURCE);
	 ...
	 * DocGenCreator
	 */
	public SDocGenCreator()
	{
		// create docgen parser
		InputStream bnfInput = SDocGenCreator.class.getResourceAsStream(SDOCGEN_BNF_RESOURCE);
		InputStream lexerInput = SDocGenCreator.class.getResourceAsStream(SDOCGEN_LXR_RESOURCE);
		...
		this._handler = new SDocGenHandler();
	...
	private String extractComments(String name, String text, boolean includeFollowingLine)
	{
		...
		while (commentStart != -1)
		{
			...
			if (commentEnd != -1)
			{
				...
				// make sure starting offset doesn't start after the ending offset. This occurs
				// when we're at the end-of-file
				nextLineStartingOffset = Math.min(nextLineStartingOffset, nextLineEndingOffset);
